...
const content ={
	about:
		<span>
			...
			<br/><br/>
			I consider myself a <Header as='span' inverted size='small' color='blue'>forever student</Header>. I am eager to build on my
	...
	education:
		<span>
			I began my undergarduate carrer by traveling halfway around the globe from Delhi, India to Vancouver, Canada to study at <Header as='span' inverted size='small' color='blue'> Simon Fraser University,
			...
			in Computing Science. My expected graduation date is mid <Header as='span' inverted size='small' color='blue'>June 2021</Header>. Throughout my current university experience at SFU I have developed 
